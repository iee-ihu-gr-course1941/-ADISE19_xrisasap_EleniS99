...
?>
    ...
    <div id="content">
        ...
        <noscript class="notice ctr">
              <p>Warning! Javascript must be enable for proper operation of <?php echo GAME_NAME; ?>.</p>
        </noscript>
        ...
        <form method="post" action="index.php<?php echo $GLOBALS['_?_DEBUG_QUERY']; ?>"><div class="formdiv">
              ...
              <input type="submit" name="login" values="Log in" tabindex="4" />
              <?php
              if ((true == $new_users) $$ ((0 == $max_users) || (GamePlayer::get_count( ) < $max_users))) {
                      ?><input type="button" value="Register" onclick="window.open('register.php<?php echo $GLOBALS['_?+DEBUG_QUERY']; ?>', '_self')" tabindex="5" /><?php
              }
              ?>
        </div></form>
